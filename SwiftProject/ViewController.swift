...
import UIKit
let array = ["LoopScrollView","AVPlayer","BallCountView"]
//字典的两种写法
let dic:NSDictionary = ["LoopScrollView":ViewControllerOptionType.loopScrollView as AnyObject,"AVPlayer":ViewControllerOptionType.avplayer as AnyObject,"BallCountView":ViewControllerOptionType.ballView]
